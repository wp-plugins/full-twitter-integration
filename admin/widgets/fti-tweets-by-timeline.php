...
class fti_slider_widget extends WP_Widget
{
    ...
    public function __construct()
    {
        ...
        parent::__construct(
            'fti_slider_widget',
            __('FTI Get Timeline Tweets', 'fti_slider_widget_domain'),
            array('description' => __('Display your latest tweets based of your timeline', 'fti_slider_widget_domain'),)
        );
    ...
    public function widget($args, $instance)
    {
        ...
        $tweetsArray = $twitterClass->get_timeline_tweets( $instance['max-num-tweets'] );
    ...
    {
        $title = isset($instance['title'])? $instance['title'] : __('New title', 'fti_slider_widget_domain');
        $maxNumTweets = isset($instance['max-num-tweets'])? $instance['max-num-tweets'] : __('New title', 'fti_slider_widget_domain');
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title of the Widget (optional):'); ?></label>
